...
label start:
    ...
    narrator "The results came back as a coded impulse of emotion and sensation that experience taught me to translate as `All OK`. Comms OK, landing went well, and not a word from FridAI. I tore my eyes away from the {i}Selkirk{/i}, looking for something else to think about."
    ...
    narrator "Staring up at that sky, that wall cutting me off from where I was most at home, I felt myself shrinking away into despair. I was a speck. I whipped my head back to face the ground, gripping it hard with my hands, wishing I could push myself up and away and escape this place right now."
    ...
    narrator "If we do make it home, it’s doubtful we’d ever get another job. Not after an incident like this. This kind of fuckup was beyond unheard of. I buried my face in my hands as if there was someone to hide from, and gripped my hair hard enough to hurt. I deserved it."
    narrator "Inside, my thoughts were racing. Outside, I was totally still, save for a few breaths as I tried to collect myself. I listened to the alien water gently slosh around me. After a few minutes I started to calm down and carefully, piece by piece, opened myself back up again."
    ...
    narrator "I pressed a switch, prompting a nozzle to spring from my collar. I tucked my chin in and bit the plastic nipple, sucking down water that my suit's integrated rehydration pack had recycled. It tasted of plastic and a slight, organic pungency I'd never learned to ignore."
    ...
    narrator "A few gulps later, my suit was dry and I hadn’t seen so much as an empty wrapper or a plastic bottle. The pack would refill itself over the next few hours, faster if I was working hard. It wasn’t 100% efficient, so I’d need to supplement my water intake somehow."
    ...
    robing "They won’t even bother to wave at us out the damn window after seeing a six-year-old timestamp. Fuck. Fuck!"
    ...
    fridai "There were fires that have since been suppressed, and the main stores were totally destroyed. I can’t be certain since surveillance has been disabled due to power restrictions, but a small amount of supplies have likely survived. Did you leave any food in your cabin?"
    robin "Just some snacks, but even without the main stores the galley has enough for a few weeks. Maybe more if I stretch it. We’ll just have to hope that’s enough time for me to do any repairs that might be needed. What I would give for just one bluespace-capable drone right now..."
    ...
    narrator "I remembered that feeling of exasperation as I wondered that age old question as I worried my teeth through an eraser, thinking, ‘when will I ever need to use this’. After all, I thought, if there’s no weight, then buoyancy doesn’t apply."
    ...
    narrator "Hence, it was common to rely on crews of full time spacers who spent their lives in null or microgravity. If you lived long enough to retire, you could easily afford the body mods and extensive medical care it would take to mostly reverse the consequences of such a life."
    ...
    fridai "I cannot, but I can ‘feel’ using the pressure sensors in the compromised, flooded compartments. I am using the data to construct a predictive model. I may be able to save you some time if you decide to search for more salvage."
    ...
    fridai "Perhaps a device that can float? But first, I recommend trying a brief swim. Even if you cannot swim the entire distance to me, it would be useful to have some practice in the case that you fall from the vehicle and find yourself adrift."
    robin "Right..."
    ...
    narrator "I didn’t know what else I’d do if this didn’t work. That big, blank stretch of water with its impenetrable surface seemed to hide every terror. I stood there, frozen, until I worked up the courage to step cautiously into the deeper waters."
    ...
    narrator "Slowly, I went deeper and deeper into the water, building my confidence. I stopped when it reached my chest. I could feel the water taking my weight, its powerful bulk shoving and tugging me, threatening to scoop me up, and it took some effort just to stay upright."
    ...
    narrator "The hot sun beats down on my head and I decide to risk dipping my head under the water to cool off. I felt a tickling on my neck and face as the air between my skin and the suit was replaced by water flooding in through the gap at the suit’s neck where my helmet would have created a seal."
    ...
    narrator "I strip down to my bra and briefs, leaving my suit crumpled beside me like molted skin. I tried my best to get as much of the gunk off of my skin as possible, but as soon as I thought I was finished, there always seemed to be more."
    ...
    narrator "The best I could do is pour the water into my suit, let it soak into the liner as my sweat would, and hope that it filtered out anything dangerous. If the leaf was coated in some toxic residue, surely it’d be better off on my skin than in my stomach?"
    narrator "After consulting FridAI, it pointed out that the system was bottlenecked by throughput; the reclaimer was carefully designed with the upper limits of human perspiration in mind, so increasing the input wouldn’t also produce a higher output unless I was so dehydrated I stopped sweating and passing urine. So much for that idea. I gingerly poured the water back into the leaf, hoping to come back for it later."
    ...
    narrator "I was forced to leave a few fruit behind that had some of those stinky nibblers hiding inside. I thought briefly about burying the ones I brought to avoid more losses, but the thought of eating sandy fruit made me discard the idea."
    ...
    narrator "I managed to gather a mere handful of leaves before I gave up, too exhausted to accomplish even this small task. With one last burst of effort I forced my deadened arms to brush the larger rocks and pebbles aside before I began to slip away into sleep."
    ...
    narrator "Spacers had a lot to fear. Being in a confined space surrounded by electrics and volatile fuels, fire was perhaps chief among them. Even the air was engineered carefully to prevent fires, the mixture balanced just on the edge of what a human could cope with."
    ...
    narrator "Having caught my breath, I thought I had one more push left in me. I slowly regained my feet and started walking, wobbling as I went. It’s a mercifully short walk, and in no time I've found a small boulder that's the sort I need."
    ...
    narrator "I point the tip of the steel knife towards the crumpled, dry leaves I was using as tinder. Then, I aimed the rock’s edge at the steel, holding the rock at a fairly shallow angle as if I were preparing to shave it with a razor."
    ...
    narrator "This time it took a lot of tries before I could actually get it to throw a spark. I was just about to give up when I managed a good blow that sent a jet of sparks spattering against the leaves."
    ...
    narrator "It was something I’d only ever seen or read about in fics. The water felt so warm on my skin that I didn’t even realize I was getting wet at first. I always thought it would be cold and stinging, I never thought it could be this soft, this gentle..."
    ...
    narrator "I saw some fraying again where I’d ripped the grass and I teased at it a bit with one finger. I snatched one of the threads and pulled at it. It sliced neatly through the green hull of the grass until it came free."
    ...
    narrator "As I played with the grass, I crouched to get a little more comfortable - only to wobble as the ground squished under my shifting weight. Peering at my feet, muddy water oozed up around my boots as if I was standing on a big sponge."
    ...
    narrator "It was my idea, but my stomach still churned at the idea of salvaging the filtration unit. It’d mean cutting into the liner of my suit too. It did a pretty good job of keeping me cool and cutting it would compromise that."
    ...
    narrator "I dragged my suit back on, then used lengths of scrap tube to fashion a sling for each pouch. They’d be easy to fill and drink from since each tube had a plastic neck and could be decoupled, so the tubes or pouches could be replaced, I guessed."
    ...
    narrator "The water I’d gathered was surprisingly clear, but still cloudy. Looking at the filtration components I’d left on the ground, I didn’t see a simple way to use those. I’d have to boil it, but heating the pouch over the fire would just melt the plastic."
    narrator "My mouth was dry and my head throbbed with an ache that was hard to ignore. The thirst had been getting to me for the better part of the past few hours. I didn’t want to think about how long I could go on feeling this way."
    ...
    narrator "I dumped the water from the pouch into the little well (I’d decided that’s what the hole was) and started scrounging up sticks and branches and other fuel. Soon I’d built a decently-sized fire only a few feet away."
    ...
    narrator "While the stones were heating, I looked for a sapling. I used my hands to snap the stem away and then drove the blade of my scrap knife into the end with a blow from a rock, splitting the stem nicely. I made an oversized pair of wooden tongs."
    ...
    narrator "I forced myself to gather more fuel and stoke the dying fire, nudging it tenderly, nurturing it into a roaring flame that would burn through the night. The hunger gnawing at me made it hard to fall asleep that night. I lay sprawled out, my face to the sky. The glare from the fire turned the sky into a dark wet smear; not a single star."
    ...
    narrator "I couldn't have imagined that a person could work their hands this hard. It was amazing seeing my broken and red skin. The only callouses I'd ever had were on the tops of my feet, where they wrapped around footholds to keep my body still in microgravity."
    ...
    narrator "I looked around for something to make a handle out of and, seeing a nearby sapling, thick, tall, and healthy, I moved to get closer. Wrapping my hand around the trunk, I felt it fit perfectly in my hand. So I bent to the task, hefting the adze head in my hand and swinging it into the base of the sapling. sending flakes of wood flying with a thunk. I winced as the blow sent shocks up my arm and into my shoulder. Having a handle would definitely do some good."
    ...
    narrator "Next, I cut carefully at the staff I’d made, shortening it until I had a raw working item that was the length of my forearm. I fashioned the item from a section of the trunk such that one end of the item ended in a fork where a branch had begun to form. The result was a piece of stout wood, roughly in the shape of a seven. This would be my handle."
    narrator "The short limb of the adze handle would be a shelf that would support the tool head. I compared the shelf with the stone head of the tool and adjusted the length of the shelf (by chopping at it vigorously) until it was shorter than the tool head."
    narrator "The raw wood of the shelf was uneven, so I needed to do some chipping and carving to make it a little better for the purpose. Once the head was sitting on it nicely, it came time to attach the thing and secure it well."
    ...
    narrator "I set the head on the shelf and lashed it there securely with some of the cord I’d made. I crossed back and forth over it, making a lopsided X shape with the lashings, to make sure the head couldn’t slide around. I tried wiggling it with my hand and it held firm."
    ...
    narrator "I had to swing over my head due to the orientation of the adze head, chopping at the trunk almost at eye level. The result was underwhelming. It was definitely an improvement over swinging a rock with my hands, but not quite as impressive as I’d imagined it in my mind. I wasn’t quite as majestic as the chiseled pioneer women from the propaganda posters that romanticized frontier life. I could use a few muscular women right about now, as much to ogle at them panting and sweating through their shirts as to have their help with the work."
    ...
    narrator "I almost didn’t want to do it. After all this work, I nearly couldn’t bear to know if it was all a waste of time. But I pulled from a deep reserve of determination, one I didn’t know I had, and rolled the log out into the water."
    ...
    # days pass
    narrator "After a few days of foraging, carving, and braiding, I had several coils of good, strong cordrope (much better than the thing, brittle crap I made at first) and a respectable row of logs, all roughly the same diameter and length, lined up at the head of the beach like soldiers."
    ...
    narrator "My hands and feet were hard from the work, and my face and neck darkened by the sun. I spent most of my time finding food to eat. I’d hunted another doglike since my first kill, and discovered some roots and nuts that were safe to eat, though they were not as abundant as the redfruit and needed much more preparation."
    narrator "In spite of my effort, I was clearly fighting a losing battle. My stomach was sunken; the suit’s smart rubber sagged where it was still slowly refitting itself to keep up with the rate I was losing weight. Each day I had less energy than the last. I panted unselfconsciously as I dragged another log down to the beach. The last one I’d need, I figured. It was about time."
    ...
    narrator "I decided a frame would be best as a base for the craft. I lifted the logs up by the ends and walked them around until they lay on top of one other, then I lashed them together with some cordrope. It was a serious upgrade over the simple cordage I’d made before, and was the result of many long hours of weaving the simple twine cord I’d made initially into thick, powerful rope. Threads to twine, twine to rope, and rope to cables if need be."
    narrator "I hefted one side of the frame and shook it back and forth to make sure it was stable, and I found the joints had some play in them. Everything was secured tightly at the corners, but it was still able to skew and make the square shape of the frame go lopsided."
    ...
    narrator "I was a little afraid that the tide would come in, scoop up my raft, and take it away, so I made some tall stakes from some of the thicker and straighter branches I had and pounded them into the sand inside the borders of the frame. With this setup, even if the raft started to float while I was away, the stakes would keep it docked on the beach."
    ...
    narrator "My chest heaved. My limbs and muscles screamed. The pain was deep, in my bones. The heat seeped through my skin, my bones, deep into my skull. I was drunk with that heat. My bones were hot and throbbing. I had a sudden, terrible vision of my bones warming and turning to soft butter, or lead. They would sag and bend under my own weight, and sag more. That frightened me. I tore my clothes away with a gasp and strode into the water."
    narrator "The cool water shocked me, brought my mind screaming back into the real. It felt so soothing that I let out a moan, even as the salt found the nicks and scrapes on my soft flesh and whipped them screaming raw. The pain was angry, thin, and everywhere. I itched and it just turned the itching into more raw and sore and crawling itch."
    ...
    narrator "I thought about the waves and tides. It was concerning that they could change so quickly and capriciously. I’d noticed them before, but no particular pattern had yet emerged. Everything on this world was so strange that I often stopped to think about the reason and the why."
    narrator "At any rate, it was time to get back to work."
    narrator "I started dropping logs onto the frame to create a platform I could comfortably sit or stand on. I considered spacing the logs out quite far to save time, materials, and weight, but decided that the risk of falling between the logs and twisting my ankle or knee wasn’t worth it."
    ...
    #timeskip
    narrator "There was a lot of lashing involved, and I needed to weave still more rope; length upon length to prevent the raft from breaking apart. On top of the regular chores like searching for food, cooking, and making drinking water, finishing the raft’s platform took the better part of several days."
    ...
    narrator "It only took a few sessions of whittling at it with my scrap knife (even with how dull it was getting) to get it into the shape I wanted. It had a broad head, about as wide at its widest point as one and a half palms, that tapered into a roughly hewn but still smooth shaft that made for a pleasant grip."
    narrator "I finished admiring my work and hopped eagerly over to the raft. I tossed the stakes and climbed onboard as the raft began floating out to sea. Squatting gently onto my knees, the rough bark of the logs digging into my knees even through the protection of my suit, I leaned over to dip the paddle into the water off to one side and gave it a hearty stroke."
    ...
    narrator "With some gentle paddling, I started to move away from land towards the ship. Excitement washed over me even as my guts started to knot into a chilling tangle of fear. It wrapped around my stomach and squeezed. Constricting. Oozing. A rising, cold terror I could taste in the back of my throat. Threatened to freeze my limbs. One foot farther, and you won’t get back. I’ll drown. There’s no tether. I’ll drown."
    ...
    narrator "I could feel my will rising, stoking my determination. Hot, nuclear fire rushed into my limbs and melted and smothered the burning hoarfrost climbing my guts. I paddled fiercely now, my body dipping. Arms pumping down, over, and down again. I have to know. It needs to work."
    robin "Come on… "
    ...
    robin "Fuck you! Yes!"
    narrator "Everything flashed through my mind. Rescue. Food. A warm, soft place to lie down. FridAI could patch me up with the medical suite, too. All the hurt, the hunger pangs, and the aching in torn and frayed parts of my body. All of it would stop."
    ...
    narrator "It was then that I felt the fear. It made a home in my heart. And my heart soared with a frenzied desperation. I knew I would escape. I thought that right up until the raft took one last wave, a huge ripper that foamed and bubbled madly, curling as it seized the lip of the raft and fired it right over my head."
    narrator "The sun was blocked out by a wall of water as I was hurled away from the raft, twisting through the air."
    narrator "I hit the water and there was nothing but a confused flurry of sensations. A rush of colors. My limbs were jerked and twisted as I spun through the whirling currents. Even as I tried to scream, the seawater forced its way into my nose and throat, filling me and driving the air out of my body. My body gasped and gulped on the water, trying to find oxygen. The taste of salt burned its way through my face and chest."
    narrator "Either I closed my eyes or I hit my head, because everything went black. In the next instant light came rushing back in and I was already flailing and clawing my way to the surface. The water that had shot its way down my throat sat in my guts and chest like so much lead."
    ...
    narrator "Favoring my left leg, I limped my way out of the water and onto the sand. I couldn’t see anything out of my right eye and for one gut-wrenching instant I thought I might have been blinded, but after gingerly probing my face with my good fingers I realized I just had blood in my eyes from a gash on my head."
    ...
    narrator "I limped back to the campfire and dropped to the ground. I just lay there for a minute, bleeding. I watched the sand drink my blood and hope greedily. The land was taking me. I thought to myself that that would be good. Then I wouldn’t have to hurt and try anymore."
    narrator "But dying wasn’t so easy as giving up. The pain came to the door, quietly first, knocking politely as my leg stung. A dull ache sang through the walls. In a few minutes it was going to be tearing the curtains down and ripping the furniture to bloody shreds, and I knew I would be useless, so I worked fast."
    narrator "My busted fingers throbbed as I yanked off the suit. The right side of the suit was torn from hitting the jagged wood of the raft, but the left side was intact, and I thought of using the compartmentalization feature to put pressure on my wound."
    narrator "Most injuries I’d seen in null-g were pretty catastrophic. A few tons of rock or ship would pulverize your hands, limbs, or head. Inertia is unforgiving in a frictionless vacuum. The really retro pressure suits would automatically cut an injured limb off at the joint to save the rest of you. Harsh arithmetic. My suit was a little kinder and it could tighten sections of the material selectively to compress the body and control blood flow. In this way, it could be used like a compression bandage to staunch bleeding."
    ...
    narrator "My suit and my calf underneath it was laid open, enough that I could see the fat under my skin. Not a strip of thick, sticky seaweed but skin, still attached by a thread, flapped against my ankle. When I saw the blood gushing out in sheets I nearly fainted."
    narrator "All of this happened in an instant, as I put my suit on backwards, sticking my wounded right leg in the intact left leg sleeve of the suit, and leaving the torso segment to flop around my waist. FridAI must have inferred the situation from the data transmitted by my implants because the suit instantly began to tighten before I gave it any commands. I screamed as it constricted my leg, wrapping tight, tight, and tighter still around me. Fresh blood oozed up from the leg of the suit and pooled around my hips, but it soon stopped."
    ...
    #the nightmare
    narrator "Her bedroom was warm. Not too hot or cold, just so. Her arms curled around me and I felt the heat of a flame in my belly, reaching out and caressing my skin and my heart. I let my fingers drip over the curve of her side and down to her back."
    narrator "Our hands met and we meshed together. I gave her a wet kiss and we giggled, me with some embarrassment, she with a low heat and delight, and I gave her another. I let myself be messy and pure and me. Me."
    narrator "I felt something wet between us and I felt a growing nausea. My body was suddenly tissue, so much light, feathery paper. I tore. My body ripped open. I turned to tell her I was sick, that I needed help, and then I realized it was she who had peeled me open. I saw the flash of her white, moonlit teeth as they sunk into my leg."

    # robin passes out and wakes up later that night
    narrator "The pain shocked me awake. I gave a wet, coughing sob. I coughed so hard that I gagged. I closed my eyes. I wanted desperately to go back to sleep and stop hurting, but the fire was low. I was shivering from the cold, not just the pain and exhaustion."
    narrator "I groaned and wormed pathetically towards the wood pile. Even without my injuries, wearing the suit backwards would have made it awkward to walk. It was all I could do to get within arm’s reach of a thin branch. By then I was panting. My body was covered in a cold sweat from the exertion. I dropped my hand onto a branch with a gasp, then willed my hand to close around it. I clumsily dropped sticks into the embers."
    narrator "Not having the energy to place them carefully, the fire was uneven and spilling from the barrier of rocks I’d built around it. Luck was with me as the fire grew nevertheless. Slowly, the heat seeped into my body, and I stopped shivering. Yet another danger had passed."
    narrator "I must have fallen unconscious the moment my guard dropped, because one instant I was warm, the next I could smell burning hair. I saw my arm being kissed by the flames before I felt it burning. In one move I yanked my arm back and kicked away from the flames with a shriek of pain, sending a spray of sand over the fire and plunging me into darkness."
    narrator "I lay there, whimpering, clutching my arm where I’d been singed and cursing my mistakes."
    narrator "Since I’d put my suit on backwards to tourniquet my leg, my arms were out of the suit. I wore only a short-sleeved shirt underneath, and my bare skin was a dull red where the flame had scorched me. I curled into a ball, hot tears flowing freely as the pain reached new, agonizing heights, and opened my mouth wide in a soundless scream."
    narrator "I couldn’t save the fire, but the coals were still hot. With feeble motions of my good leg and the single-minded determination of a desperate woman, I managed to shovel a layer of sand onto the remains of the fire, enough to protect my skin. I crawled onto the buried coals, letting them heat the sand and warm my body."
    narrator "Warm though I’d be (for now), with a lullaby of throbbing pains to torture me sleep would not come. I don’t know how long I lay there."
    ...
    narrator "I’d been awake during the night before, of course, but the glare of the fire always masked my surroundings. Now, in the dark and with my eyes adjusted for the first time I saw the sky as it really was. Lit by the bright moons and stars overhead, it glittered brighter than any city-station."
    ...
    narrator "I thought about FridAI. Fuck, it must be worried sick."
    robin "FridAI?"
    ...
    narrator "That’s when I saw the ocean."
    ...
    robin "Promise?"
    fridai "I promise."
    narrator "I felt a pang of terror and guilt as I realized that FridAI must be running low on power after so long waiting for me. It was in real danger of having to shut down completely. It relied on the power supply being uninterrupted and there were few opportunities to make backups. There was no telling what kind of memory loss would occur if its reactor stopped. Cardiac arrest."
    robin "Are you sure it’s OK?"
    fridai "Yes."
    robin "Don’t bullshit me."
    fridai "I’m scared too, okay?"
    narrator "Even in that moment, even with me at death’s door, it was so calm. In that instant, I hated it for being so strong. I felt another stab of guilt. You’re not thinking straight. You didn’t mean that. I took some deep breaths, as much to soothe my emotions as the pain."
    ...
    narrator "I looked. A few heartbeats passed. Then, I saw flickering as the {i}Selkirk{/i}’s running lights blinked to life, one at a time. The lights winked on and off in rhythmic, playful patterns. I’d never have been able to see them in the daytime, but here they shone as brilliantly as any star. It was beautiful"
    ...
    narrator "I propped myself up on one elbow and looked out at the sea. I thought about what I’d seen last night. The coral was so close to the surface, breaking through in some places. I knew from books that it could be hard, and grew on rocks. If I ran into the rock supporting the coral, it could have flipped the raft over."
    ...
    narrator "But how is that possible? Rock doesn’t exactly migrate overnight. I couldn’t have just floated around it. I took the shortest path towards the {i}Selkirk{/i}, and at night the coral reef almost looked like a bright, beautiful bridge leading straight to the ship. I had to have floated over it."
    ...
    narrator "I gingerly tested my bad leg. My skin was so swollen that I thought I would split open, and as I pressed down harder the painful throbbing built to an agonizing pounding, but the bones did not shift and the muscles did not buckle and I could put weight on it."
    narrator "It was good that I could walk, but I could only push myself so far. I had to think about how I was going to spend that time carefully. I had until nightfall, when the water level changed, to think about how I was going to cross the reef. I knew I would die here if I didn’t cross tonight."
    narrator "I had no idea what was in store for me. I’d only seen corals in pictures. The stone they grew on looked unforgiving. Some distant, muted part of my mind muttered to me that some corals could sting. I needed to protect my feet if I wanted to have any hope of making the crossing."
    ...
    narrator "I nibbled anxiously on a strand of ropegrass, feeling it fray and come undone in my mouth, letting the tickling sensation distract me from the gummy feeling in my mouth and the deep rut that hunger had furrowed into my stomach as my body began to eat itself."
    narrator "I wriggled my feet, testing the ropegrass sandals I’d made. I spent all morning puzzling about how to save my feet, and playing with the idea of making shoes from the plastic and metal I had. In the end I settled on making something flexible and cheap."
    narrator "I didn’t have any spare cord after building the raft, and it took hours to make enough rope to coil into rough soles, and still more hours to work out how to use the cordage I had to stitch and weave it together into something that wouldn’t fall apart."
    narrator "I played with the idea of using them as insoles, but they were too difficult to fit neatly into my skin tight suit. The smart rubber of the suit had time to reform overnight and adapt to being worn reversed. It was stiff and uncomfortable, but I could actually pull the leg sleeves entirely over my feet. In the end, I secured them over the suit rubber encasing my feet using a liberal amount of ropegrass cord."
    ...
    narrator "Night crept onward, and I waited patiently. The dark held me, preventing me from doing anything but sitting and waiting by my fire. Eventually, I felt I didn’t want to wait any longer, though the coral barely seemed to breach the surface yet, and I hauled myself up on a scavenged wooden walking stick and set out into the surf."
    narrator "Even before the water reached my knees I could feel the sharp points of rocks poking through the mud and into my feet. It didn’t penetrate the sandals, but the pressure was painful, and the only relief was to lift my feet and keep moving forward."
    narrator "I was soaked. It had, unhelpfully, begun to rain, and my upper body was still clad only in my undershirt, so I paused to pull the upper part of the suit on. Only my good leg, clothed in the damaged leg of the suit, was exposed to the balmy waters that lapped at my calves."
    narrator "I pressed on, deep into the night.  The water grew deeper as I went further out to sea, but ceased rising around the midpoint of my thighs. The mud gave way to bare jagged rock, and it felt like walking on a sea of elbows, the bony points jabbing between my metatarsals. My feet were screaming in pain, and the {i}Selkirk{/i} seemed only slightly closer."
    narrator "It was awkward, slow going. I found that using my eyes to judge where to step led only to stumbling and near falls. The small waves splashing into me didn’t do anything to help my balance, and my muscles burnt with the effort of keeping me upright."
    narrator "As I got further from the shore, a feeling of dread crept its way into my heart. I imagined myself getting too tired or too hurt to go on. The flat, hot blade of the sun sliding its way up the horizon like a flaming guillotine as my time ran out and the water slid its way up to my neck, past my lips, spilling into my lungs, suffocating me."
    narrator "I knew someone once, a waterworks maintenance technician. Had a job working inside a station’s sump. Before he went inside the tank they swore up and down that it was isolated from the rest of the plumbing. He was doing some tack welding, minding his own business, when the tank started flooding with him in it. They got him out, but not before he’d nearly drowned. I remembered the faraway look in his eyes when he recounted the agony as his lungs and throat gulped at nothing."
    ...
    # reaching the ship
    narrator "I would have bashed my head right into the hull if it weren’t for the expanding shadow implying the looming hull of the {i}Selkirk{/i}. I planted my feet firmly, trying to get as comfortable as possible, before taking the time to slowly look up. I could see the fine details of her hull, the seams of her ablative panels, and the bulge of plumbing where vital coolant and potables flowed."
    ...
    narrator "I slipped once, catching myself with a free hand. Where my palm brushed the coral I could feel a tingling that grew into a wicked burning sensation, like I was on fire again. I grit my teeth so hard I could feel the enamel creak, and pressed forward. Nothing mattered except getting inside."
    narrator "I felt the rock plunge away suddenly and I fell face first into the water. I came up spluttering and let my walking stick fall into the water, drifting away. I paddled desperately toward the gash. It didn’t look wide enough to squeeze through, but I was too close to escape to stop now."
    narrator "I gripped the edges of the gash and pressed myself into the gap, kicking and shoving my way through. The jagged edges of ceramic and metal dragged at my face and shoulders, and I exhaled and held my breath to keep from impaling myself. The wicked ribs of the ship ripped bloody gouges into my face and shoulders as I pulled myself forward relentlessly, eyes squeezed shut, unable to turn or wiggle backwards, and I moaned in a desperate, primal terror as I shivered my way through the tangled wreckage."
    narrator "Finally, the barbed and twisted metal gave way and I fell into thin air, flopping with a great splash onto the waterlogged deck. I trembled and shook from the cold of the water seeping into my suit. The deck was canted at a significant angle, sloping away from me and threatening to send me tumbling against the far wall. Even on this somewhat kinder ground my feet still felt like they were full of glass. I felt I’d surely cracked a few bones from the harsh walk."
    narrator "Blood sheeted down my face and arms. I wiped my face and threw myself at the nearest hatch with a grunt. I cranked it open manually, passed through along with a deluge of water, and sealed it behind me to prevent more flooding."
    narrator "In this manner I made my way through the cold, darkened halls of the {i}Selkirk{/i} to my quarters by feel and memory alone. My hands shook from chill and excitement, fingers refused to obey. I could only manage to roughly pull drawers out and sift through my things with my palms until I caught a handful of chemical hand warming packets I’d stashed. I squeezed pathetically, trying desperately to crack one with the little strength I had left, then resorted to grabbing a hardcover manual that I had lying around and smashed them ruthlessly."
    narrator "As I felt the packets growing warm, then hot, I shoveled them into my suit, squeezing them under my armpits and under my chin, then yanked the sheets off my bed and rolled into a clumsy ball to wait for the shivering to stop."
    robin "Fry..."
    ...
    narrator "I reached for the tablet that teetered on the edge of my workstation. My fingertips caught the edge of it and tipped it to the floor with a crash. With trembling fingers I booted it up. It sensed my implants and logged me in automatically. I brought up the command line in admin mode and checked FridAI’s status."
    robin "Damn you. I knew it..."
    narrator "It had started a hard shutdown sequence to save power. Power I’d need to bring the reactor back up to baseline. It was the smart thing to do, if the reactor was allowed to shut down completely we would never get it back online, but with no power FridAI’s personality, memory, and entire self, would be lost forever. An AI can’t be restored from backup any more than a human brain could."
    narrator "So I decided to take a chance of my own. I didn’t bother checking if there was enough power to hold FridAI in memory {i}and{/i} reboot the reactor. I punched in the command to cancel FridAI’s hard shutdown. Maybe, just maybe, I had caught it before its memory lost power."
    narrator "My fingers were numb as I hit the reactor restart sequence next. As I confirmed the commands, the tablet slipped from my fingers, and I followed it and dropped to the deck not long after. Completely and utterly spent, I slipped into a fitful sleep."
    ...
    narrator "I reckoned it had only been a couple weeks on the island, and then about 6 months back aboard the grounded {i}Selkirk{/i} before I was able to get her spaceworthy again. Now, back in space, it felt good to be away from the strangling hold of gravity. I drifted through the halls, wearing a bored expression, doing my rounds. If it weren’t for the aches and scars where the medbay had stitched my body back together, it would almost have been as if nothing happened."
    narrator "Almost. I was much less comfortable wearing the suit, for one, and I did a lot of my work in just underclothes now."
    narrator "It didn’t hurt as much to remember, now."
    narrator "When I awoke from that hard sleep that came after my first day back, I pulled myself together a bit and got back onto my portable terminal. The gamble had paid off. The reactor was stable, power stored in the capacitors was actually {i}increasing{/i}, and FridAI was online but effectively comatose after taking itself partly offline."
    narrator "I spent days walking the ship diagnosing, triaging, and treating the  extensive damage. The reactor was in bad shape, and reversing the flooding was long and difficult work, but soon I had things patched up enough that I felt the ship wasn’t going to disintegrate while I wasn’t looking."
    narrators "Then, it was long days of exhaustively checking and cataloging everything to prepare for escaping to orbit. I remembered that sinking feeling as I assessed the damage. The flooding had been contained and a takeoff would be possible, but the water had damaged the AI compartment most of all."
    ...
    narrator "My heart was in my mouth as my finger hovered over the control that would key the reboot macro I’d written by hand. AI don’t get shut down partway and then rebooted, it simply wasn’t done. I had to come up with the procedure myself."
    narrator "I breathed hard, my eyes screwed shut."
    robin "Do it. Do it. Just get it over with."
    narrator "What if it doesn’t wake up? What if it’s not FridAI anymore?"
    narrator "The fear built to a crescendo as I channeled all of my will into my fingertip. Slowly, I forced my fingertip down, and pressed the control. A gentle chime confirmed my input."
