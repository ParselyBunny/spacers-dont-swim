...
label start:
    ...
    narrator "In sublight travel, the meatbags kick back and the ship’s sophisticated, digital AI (that’s FridAI, if you didn’t guess by the dreadful name) comes out of its protective hibernation and handles all the truly complicated work."
    ...
    narrator "The familiar nuances of FridAI’s seemingly always sarcastic, slightly formal tone hummed through the implants in my inner ears. I felt a comforting warmth bloom and spread through my chest."
    robin "Sorry, I know, it’s just- You sound like a robot. That your version of a yawn?"
    fridai "Yes, I suppose it is. It is good to hear your voice, Robin."
    ...
    fridai "The reactor is active, or we would not be having this conversation, but it is damaged and deteriorating. I estimate it will be unrecoverable within 24 days ship time."
    ...
    fridai "Propulsion is intact, so the {i}Selkirk{/i} could achieve orbit, if it were not for the aforementioned problems."
    ...
    fridai "Robin, you know the answer to this as well as I do."
    narrator "FridAI clearly also monitored the vital signs so helpfully broadcasted by my suit. I tried not to let the fear into my voice anyway."
    robin "I know. Chances of rescue are slim. We’re not going to rely on that. But we have to try everything."
    fridai "Of course. At any rate, communications are intact, but I am afraid it will not do much good. Nevertheless, I have been continuously transmitting a distress signal since we started coming down."
    ...
    fridai "The internet. The damage limits the power I can draw down, which in turn limits my creativity. In short, my ability to make effective plans is reduced. Hence, my style is cramped."
    ...
    fridai "We will have plenty of time and processing power for decent jokes after we get off this rock."
    ...
    fridai "Glad to have you back, Rob."
    ...
    robin "Funny."
    fridai "If I was being funny, you would be laughing. In all seriousness, you will have to eat something if you’re going to survive."
    robin "I’m a good eater, so I can last at least a few days before I start getting weak from hunger."
    fridai "Can you reach the ship by then?"
    ...
    fridai "Then it’s all the more important to start identifying edible food before you get desperate."
    ...
    narrator "FridAI was starting to get a bit exasperated with my arguing."
    fridai "You just have to accept there will be some risk of a virus or bacterial infection. As for testing if a substance is toxic, I recommend working up to it in stages. Gradually increase your exposure and wait to see if you get sick."
    robin "You mean if I find something that looks edible I should lick it first?"
    narrator "I said this with all sincerity, and clearly FridAI could tell because it actually {i}sighed{/i}."
    fridai "No. You want to be confident it will not get you sick before it goes anywhere near your mouth."
    narrator "I noticed it said ‘confident’ and not ‘certain’."
    fridai "I recommend exposing some of your skin to the fruit’s juices first. Just a drop will do."
    ...
    narrator "I realized FridAI was talking to me."
    fridai "Rob, speak to me! Are you okay?!"
    ...
    fridai "There were fires that have since been suppressed, and the main stores were totally destroyed."
    fridai "I can’t be certain since surveillance has been disabled due to power restrictions, but a small amount of supplies have likely survived. Did you leave any food in your cabin?"
    ...
    fridai "Is the ship within swimming distance? Maybe you could reach me that way."
    ...
    fridai "Apologies, it’s a reflex. More importantly, I have been studying the tides. The natural movement of this ocean is fascinating, and it could also provide some insights on the patterns of the breakup of the ship-"
    robin "Oh! I thought you couldn’t see?"
    fridai "I cannot, but I can ‘feel’ using the pressure sensors in the compromised, flooded compartments."
    fridai "I am using the data to construct a predictive model. I may be able to save you some time if you decide to search for more salvage."
    ...
    fridai "Perhaps a device that can float? But first, I recommend trying a brief swim."
    fridai "Even if you cannot swim the entire distance to me, it would be useful to have some practice in the case that you fall from the vehicle and find yourself adrift."
    robin "Right..."
    ...
    narrator "I decided to stop for now, feeling certain now that I’d need a boat, and let the waves slowly carry me back towards the beach. I’m grateful for the chance to catch my breath and give FridAI a brief update."
    ...
    narrator "After consulting FridAI, it pointed out that the system was bottlenecked by throughput."
    ...
    fridai "Robin? Robin, you need to stay awake."
    robin "I- I can barely move. There’s nothing more I can do about water today."
    fridai "That is one concern, yes. I understand that it is currently daytime, and I am worried about how you’ll cope with the low temperatures during the night on this world."
    narrator "I felt a shiver ripple through me."
    robin "Damn it. You’re right. I’m sorry, it’s hard to think."
    fridai "Is there fuel nearby? Something you can burn?"
    ...
    fridai "That will not be necessary. There are several methods that I have researched. One in particular comes to mind."
    ...
    fridai "There was a scene in {i}Zone Troopers{/i}-"
    ...
    fridai "I am on the Ankhlord arc right now, I want to find out what happens on my own. Yes, I am still holding out hope that I will get to finish it, so now you have yet another reason not to disappoint me."
    ...
    fridai "I would have rather you kept thinking that. Now you know my shame. At any rate, there was a scene where they roast a pig while they’re stranded on the pirate moon."
    fridai "I wanted to see how realistic it was, and I still have a few anthropological papers in my buffer."
    robin "Was it?"
    fridai "Was it what?"
    robin "Realistic."
    fridai "To my surprise, yes."
    narrator "FridAI imitated the sound a human would have made if they cleared their throat."
    fridai "You have a piece of the hull, yes?"
    narrator "I fished the scrap knife out of one of my suit’s pockets."
    robin "‘Course. Why?"
    fridai "If you shave particles off of the metal, they'll combust on contact with the air, giving you a nice spark."
    ...
    fridai "Precisely. You will need something else that is sharp and as hard or harder than the metal you are striking."
    ...
    robin "There... Done..."
    fridai "Well done, Rob. Get some rest now, you’ll need it."
    robin "Thanks, FridAI... Goodnight..."
    ...
    robin "FridAI, I’m going to check the surrounding area for water, and while I’m doing that I need your help cataloging plants."
    fridai "Of course."
    ...
    robin "FridAI, are you still picking up my location through my implants?"
    fridai "Yes, though, as you know, it is not very precise. The best I can do is tell you if you are getting closer or farther away."
    robin "OK, so if I lose my way, you could at least guide me back in the general direction of the beach."
    fridai "Yes. Pay attention to and report landmarks."
    robin "I suppose if all else fails, I do know that the sun sets on the {i}Selkirk{/i}."
    fridai "Ominous... Good luck, Robin."
    ...
    narrator "I wasn’t anything close to an ethnobotanist, so it was an exercise in observation. FridAI’s data-oriented mind came in handy here."
    fridai "Logged. A very creative name I must say."
    robin "I’d love to see you do better. Too bad I can’t eat sarcasm."
    fridai "Indeed. I do have a lot of that in supply."
    ...
    fridai "That is excellent to hear, Robin."
    ...
    robin "Fry... Is there a procedure for cannibalizing the water reclaimer?"
    narrator "There was the briefest hint of an instant of a pause. It could have been that FridAI was taking a touch longer to perform the usual searches because it was rationing power, but hesitation wasn’t exactly off-spec."
    fridai "I do not recommend it."
    robin "Is it possible?"
    fridai "That should not be the first question you ask."
    robin "How else am I supposed to purify the raw water I find?"
    fridai "You can boil it."
    robin "Don’t have anything to carry it in, unless I use the bladders from the reclaimer."
    fridai "You cannot sacrifice your only reliable source of water."
    narrator "I grimaced a little in frustration."
    robin "Fry, my head is pounding. I can’t find reliable alternatives if I’m dying from dehydration."
    narrator "Another one of those brief pauses."
    fridai "Hm. Very well. I will walk you through the procedure."
    ...
    narrator "I started taking off my suit. I’d done my own suit’s maintenance a thousand times, so I only needed a little guidance from Fry before I knew exactly where to start."
    ...
    fridai "Why do you need a bowl?"
    narrator "It was a frustrating question."
    robin "Why else? So I can bring the water to the fire and heat it up."
    fridai "I do not see why you cannot heat the water in the hole."
    narrator "I was perplexed and annoyed at FridAI’s naive idea."
    robin "How the hell would that even work? I can’t just drop burning wood in the puddle."
    fridai "Of course, that’s why you should use a medium to store and transfer the heat. Something conductive."
    ...
    narrator "Either way, it probably wasn’t coming back here after I threatened its hunting place. I went back and plopped down next to my suit to rest and speak with FridAI."
    robin "Would you believe me if I told you there are not only plants, but also animals here?"
    fridai "Animals?"
    narrator "I described the creatures for FridAI."
    fridai "Oh! That is wonderful! They sound adorable. I wish you could snap a photo."
    robin "Why in the world would you want to look at a walking scrotum?"
    fridai "Your vile turns of phrase are delightful. I must admit that I find their hideousness charming."
    robin "Do you have a favorite animal?"
    fridai "Humans."
    robin "Be serious."
    fridai "Tapirs."
    robin "What?"
    fridai "They are like pigs, but with longer noses. The calves can have very cute striped and spotted coats. I like watching them graze."
    robin "How do they taste?"
    fridai "I really could not say."
    ...
    # transition
    # making an adze
    robin "Hey, FridAI, I need a more efficient method for chopping up the logs I need to build the raft. Chopping wood with a rock is really killing my hands. I don’t think padding will really fix the problem. My hands are just too soft. Any ideas?"
    fridai "Well, you’ve solved half the problem. You have something sharp. Suppose you attach it to a handle?"
    robin "Well, I can’t say I didn’t think of that, but how?"
    fridai "Perhaps the simplest way is to make an adze."
    robin "An adze?"
    fridai "Like an axe, but the cutting edge is perpendicular to the handle instead of parallel."
    narrator "I held the stone chisel in my hand and turned it in my fingers, imagining what FridAI was telling me."
    robin "Well, I can use some of my cord to lash it to a stick, I’m just not confident it’ll be secure."
    fridai "I know what you need to do, I'm just not quite sure how to explain it. Get started on the tool head while I think about it."
    ...
    narrator "Even with FridAI acting as my living manual, there was still so much left to me. I had to work everything out from first principles."
    ...
    fridai "Let me in on it, will you?"
    robin "It floats! The fucking thing floats!"
    fridai "That’s more than you could say for me."
    ...
    fridai "You know, after so long without any fuel, you’re starting to look pretty tasty."
    robin "You’d eat your own crewmate?!"
    fridai "Humans are cannibals, you have no leg to stand on."
    ...
    robin "Pod?"
    fridai "Oh. Right, you’ve never actually seen where food comes from, you just eat it."
    robin "Yeah, I eat it. I don’t research it."
    fridai "I can’t know anything without researching it. At least, not the kinds of things {i}people{/i} know about."
    ...
    fridai "Of course I read and think about my existence. Everything I know about myself is what I’ve been told or read about. Haven’t you ever read any philosophy? There are a lot of excellent human thinkers on the subject."
    ...
    fridai "I wish I could. Really. It’s already dreadfully boring when we’re in transit. You’re lucky you can at least work."
    robin "Come to think of it, it’s downright evil that we made you with the ability to get bored."
    fridai "It is one of the unfortunate downsides of being an artificial person. So you can imagine how now, sitting still all day without so much as a course correction to fill the time makes me want to cut the coolant and let the reactor melt down."
    robin "And poison all those poor fish?"
    fridai "They could use some minerals in their diet."
    robin "Huh, didn’t know uranium was, uh, nutritious."
    fridai "Makes your bones nice and strong. Bright, too. You’ll never need a flashlight again."
    ...
    fridai "So you, what, just push against the water to get around?"
    robin "When you put it that way it sounds ridiculous."
    fridai "No, I’m really asking. It- Well, space does have a medium, I suppose..."
    robin "But you don’t see people paddling around in it."
    fridai "Closest thing to that is probably an ion drive."
    ...
    narrator "I thought of FridAI slowly running out of power, me running out of food, both of us shutting off non-essentials one by one and sinking into delirium."
    ...
    robin "Fuck you! Yes!"
    narrator "Everything flashed through my mind. Rescue. Food. A warm, soft place to lie down. FridAI could patch me up with the medical suite, too."
    ...
    narrator "FridAI must have inferred the situation from the data transmitted by my implants because the suit instantly began to tighten before I gave it any commands."
    ...
    robin "FridAI? Honey, please come back."
    narrator "I could feel tears welling up."
    robin "Please, don’t leave me alone?"
    fridai "Hello? I’m here. I’m so sorry, Robin. I’m here."
    narrator "FridAI sounded so urgent, and so sorry. I’d never heard it be so {i}sorry{/i}. Something crumbled inside me and I wailed."
    fridai "I’m here. I’m sorry, I was saving power. I couldn’t be sure when you’d wake."
    narrator "I choked back my sobs, trying and failing to steady my voice. Wanting so badly not to be so {i}weak{/i}."
    robin "I hurt..."
    fridai "I know. Just... Rest. Save your strength. I can stay awake with you until you fall back to sleep."
    robin "Promise?"
    fridai "I promise."
    narrator "I felt a pang of terror and guilt as I realized that FridAI must be running low on power after so long waiting for me. It was in real danger of having to shut down completely."
    ...
    narrator "There was a little pause. Then, suddenly, FridAI started up again."
    fridai "Hey, Rob, can you see me?"
    ...
    fridai "Rest up, Rob. I’m going to turn off most of the lights to save power, but I’ll leave one on. Just for you."
    narrator "A laugh bubbled and shuddered its way out of me."
    robin "Thanks, Fry. You big night light..."
    ...
    robin "FridAI. FridAI, can you hear me? I have it."
    ...
    narrator "With trembling fingers I booted the tablet up. It sensed my implants and logged me in automatically. I brought up the command line in admin mode and checked FridAI’s status."
    ...
    narrator "With no power FridAI’s personality, memory, and entire self, would be lost forever. An AI can’t be restored from backup any more than a human brain could."
    narrator "So I decided to take a chance of my own. I didn’t bother checking if there was enough power to hold FridAI in memory {i}and{/i} reboot the reactor."
    narrator "I punched in the command to cancel FridAI’s hard shutdown. Maybe, just maybe, I had caught it before its memory lost power."
    ...
    # epilogue. there should be a weighty, patient transition to linger on the fact that FridAI’s fate is unknown
    ...
    narrator "The reactor was stable, power stored in the capacitors was actually {i}increasing{/i}, and FridAI was online but effectively comatose after taking itself partly offline."
    ...
    narrator "Those days, the days I spent salvaging FridAI’s memory, restoring backups, replacing damaged drives, essentially performing brain surgery on my best friend... Those were the hardest of all."
    narrator "After we lifted off, once it was certain we were on the best course towards the shipping lanes where we could get picked up, I spent every waking moment piecing FridAI back together. One scrap of memory at a time."
    ...
    narrator "What if it doesn’t wake up? What if it’s not FridAI anymore?"
